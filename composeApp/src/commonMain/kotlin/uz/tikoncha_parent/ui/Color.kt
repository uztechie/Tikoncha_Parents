...
val PrimaryColor = Color(0xFFc3955b)
val PrimaryAlphaColor = PrimaryColor.copy(0.6f)
val PrimaryGraColor = Color(0xFF335B39)
val LightGrayColor = Color(0xFFF3F4F7)
val LightColor = Color(0xFFFFFFFF)
val GrayColor = Color(0xFFAFAFAF)
...
val TitleLightColor = Color(0xFF482800)
val TitleDarkColor = Color(0xFFF1EEE2)
...
val CardColors = Color(0XFFFFFFFF)
